...
At startup, embeds registered tools' names and descriptions into a vector space.
When route_tools is called, embeds the query and returns the top-k most
similar tools by cosine similarity.
"""
...
class ToolRouter:
    """Routes user queries to relevant Intervals.icu tools via embedding similarity."""
